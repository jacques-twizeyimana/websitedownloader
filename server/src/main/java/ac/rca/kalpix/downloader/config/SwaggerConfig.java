package ac.rca.kalpix.downloader.config;
...
public class SwaggerConfig extends WebMvcConfigurationSupport {
    ...
    public Docket api() {
        ...
        }).select().apis(RequestHandlerSelectors.basePackage("rw.ac.rca.ne.cedric.server.controllers")).paths(PathSelectors.any()).build().apiInfo(apiInfo()).securitySchemes(Arrays.asList(apiKey())).securityContexts(Collections.singletonList(securityContext()));
    }
